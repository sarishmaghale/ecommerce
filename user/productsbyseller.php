...
<body>
    ...
    while ($data = mysqli_fetch_assoc($all_product)) {
            ...
            while ($rows = mysqli_fetch_assoc($info)) {
                ...
                <div class="card">
                    ...
                    <div class="caption">
                        ...
                        <p class="view_details"><a href="products_dt.php?pid=<?php echo $rows["product_id"]; ?>"> View
                                Details</a></p>
                    </div>

                    <button class="add" name="add" data-id="<?php echo $rows["product_id"]; ?> ">Add to cart</button>
